%---------------------------------------------------------------------------------%
% Archivo raíz para la representacion de diferentes aspectos de los resultados de las simulaciones para distintos AoA
...
mensaje = 'Estudio de la influencia del AoA';
